...
Usage:
    python -m policy_monitor.unctad                # incremental (missing years only)
    python -m policy_monitor.unctad --full         # all HISTORY_YEARS
    python -m policy_monitor.unctad --year 2022    # specific year
    python -m policy_monitor.unctad --force        # re-fetch already-stored years
"""
...
def get_db() -> sqlite3.Connection:
    ...
    conn = sqlite3.connect(UNCTAD_DB)
