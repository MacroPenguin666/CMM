...
from policy_monitor.config import AISSTREAM_API_KEY, AISHUB_USERNAME
...
CONFIG_PATH = DB_DIR / "reference" / "config.json"
...
def _load_config() -> dict:
    ...
    return {
        "aisstream_api_key": AISSTREAM_API_KEY or cfg.get("aisstream_api_key") or "",
        "aishub_username": AISHUB_USERNAME or cfg.get("aishub_username") or "",
    }
