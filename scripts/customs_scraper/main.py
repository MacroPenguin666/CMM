...
def _parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--from-xls", metavar="FILE",
                   help="Parse HS codes from a local XLS/XLSX/CSV file (use with --bootstrap-hs-codes)")
...
def main() -> None:
    ...
    if args.bootstrap_hs_codes:
        ...
        bootstrap_hs_codes(from_xls=args.from_xls)
        if not args.from_xls:
            bootstrap_countries()
        return
