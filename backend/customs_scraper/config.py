...
# Central database: data/cmm.db (the single top-level data dir, shared project-wide)
from backend.storage import DB_PATH as _STORAGE_DB_PATH
_CENTRAL_DB = str(_STORAGE_DB_PATH)

DB_PATH: str = os.getenv("DB_PATH", _CENTRAL_DB)
