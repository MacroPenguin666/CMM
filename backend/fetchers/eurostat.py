...
Usage:
    python -m backend.fetchers.eurostat             # fetch all datasets
    python -m backend.fetchers.eurostat --show      # list stored datasets
    python -m backend.fetchers.eurostat --dataset ext_lt_maineu
    python -m backend.fetchers.eurostat --indicators rd_e_gerdtot
"""
...
def main() -> None:
    ...
    if args.show:
        ...
        conn.close()
        if not datasets:
            print("No Eurostat data stored. Run: python -m backend.fetchers.eurostat")
            return
