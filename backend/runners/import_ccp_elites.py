...
Usage:
    python -m backend.runners.import_ccp_elites
    python -m backend.runners.import_ccp_elites --xlsx data/raw/cpc_elite_leadership.xlsx
...
from backend.fetchers.ccp_elites import SCHEMA, _DB_DIR, _DB_PATH, get_db
from backend.storage import RAW_DIR

log = logging.getLogger(__name__)

SOURCE_URL = "https://cpcleadershipdata.pages.dev/CPC_Elite_Leadership_Database.xlsx"
DEFAULT_XLSX = RAW_DIR / "cpc_elite_leadership.xlsx"
