...
def run(
    ...
    """
    from backend.fetchers.wits import get_trade_stats_db, fetch_all as wits_fetch
    from backend.fetchers.wto import fetch_all as wto_fetch
    from backend.fetchers.ilo import fetch_all as ilo_fetch
    from backend.fetchers.oecd_tiva import fetch_all as oecd_fetch
