...
def _has_opensky_credentials() -> bool:
    ...
    from backend.fetchers.flights import _load_credentials
...
def _fetch_flights():
    ...
    try:
        from backend.fetchers.flights import fetch_flight_positions, get_flights_db, store_flight_positions
        conn = get_flights_db()
